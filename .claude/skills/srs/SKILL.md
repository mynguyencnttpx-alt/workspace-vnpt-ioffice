...
| `references/workflow-diagram-skill.md` | Quy tắc vẽ Activity Diagram swimlane | **BẮT BUỘC** trong WRITE mode, ngay sau writing-rules.md |
| `references/workflow_renderer.py` | Script Python vẽ diagram → PNG | Copy và điền WF data khi cần vẽ flow |
