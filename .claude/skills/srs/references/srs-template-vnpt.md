...
[Vẽ luồng theo kiểu Activity Diagram — có thể có hoặc không tùy trường hợp:
- Nếu chức năng có quy trình rõ ràng → vẽ diagram
...
|------|-------|-----------|----------------|
| 1 | <Actor> | <Mô tả thao tác> | <Hệ thống xử lý gì — validate, lưu DB, v.v. Nếu có gửi thông báo ghi ngắn "Hệ thống gửi thông báo" — chi tiết để ở mục Thông báo & Log> |
