...
| OQ-36 | Lịch sử hỏi đáp AI (cập nhật OQ-13) | Lưu tự động, chỉ chủ tài khoản xem, giữ 90 ngày rồi tự xóa, xóa được từng hội thoại; Quản trị viên không xem lịch sử cá nhân; nhật ký AI quản trị theo chính sách riêng, khi xóa có thông báo bản ghi phục vụ kiểm tra chất lượng vẫn được giữ. | Đã thống nhất với BA 21/09/2026, chờ khách hàng xác nhận |
