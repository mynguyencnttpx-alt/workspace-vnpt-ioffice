...
| # | Items | Control type | Data type | Description |
|---|-------|--------------|-----------|-------------|
| 1 | Câu hỏi của nhân viên | Chat bubble | ReadOnly | • Nguyên văn câu đã gửi, căn phải; không sửa/xóa sau khi gửi (đã chốt 23/09/2026). |
...
| 3 | Danh sách hội thoại | List | Click | • Mỗi dòng: tiêu đề (câu hỏi đầu tiên, cắt gọn), dịch vụ · site, số lượt, thời gian gần nhất; mới nhất trước, nhóm Hôm nay / Tuần này / Cũ hơn (đã chốt 23/09/2026); tải thêm 20 hội thoại/lần.<br>• Bấm 1 dòng → mở lại đúng hội thoại ở `noibo-ai-khung-chat`/`noibo-ai-tra-loi` để hỏi tiếp trong cùng hội thoại.<br>• Site/dịch vụ đã đổi hoặc mất quyền: chỉ xem, không hỏi tiếp; bài trích dẫn đã ẩn ghi "bài không còn"; AI đang tắt: chỉ xem và xóa (OQ-36).<br>• Hội thoại đang mở gắn với 1 ticket, ticket đó đổi trạng thái/chuyển OneBSS ngay giữa lúc chat → vẫn giữ liên kết bình thường, không cắt hay báo lỗi (đây là hội thoại trao đổi với AI, không phải trao đổi ticket); nút "Chèn vào phản hồi" theo đúng trạng thái ticket tại thời điểm bấm (đã chốt 23/09/2026). |
...
|----|-------------------|---------|------------|
| OQ-34 | Phạm vi nghiệp vụ nhân viên xem được trong Hỏi đáp AI | Một số vai trò được phân quyền xem nghiệp vụ của toàn bộ khách hàng/site (quyền gắn cố định theo vai trò, xem `qt-ma-tran-phan-quyen`); vai trò còn lại chỉ thấy site trong phạm vi phụ trách/tầng của mình (cập nhật 24/09/2026, thay "team"); nội dung dành riêng cho nội bộ chưa thuộc phạm vi. | Đã chốt (khách hàng xác nhận, 21/09/2026) |
