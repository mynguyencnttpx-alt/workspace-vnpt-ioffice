...
>
> **Cập nhật 24/09/2026 (v1.1/v1.2 — mô hình hỗ trợ & định tuyến theo địa bàn, vào từ site dịch vụ; khách hàng xác nhận):** thêm tab **Danh mục Địa bàn** (`qt-danh-muc-dia-ban`); khách hàng có **Địa bàn + Hình thức hỗ trợ → Tầng tiếp nhận** (thay quy tắc "loại khách hàng quyết định team"); mỗi site khách hàng dùng có **Mã đơn vị trên site**; 7 vai trò nội bộ (thêm Agent helpdesk, Hỗ trợ dịch vụ; "Agent trung tâm" đổi thành Hỗ trợ trung tâm), bỏ ô Team, thêm **Địa bàn + Phạm vi phụ trách**; Chi tiết tài khoản hiện **Danh tính site**; bảng quyền 8 vai trò. Nguồn: `SRS/quan-tri-nguoi-dung/SRS.md` v1.2.
...
│ Bộ Nội vụ         Trung ương Hỗ trợ TT       site-bnv +1     P.Thị D │
...
| 3 | Lọc loại KH / địa bàn / site / tầng | Dropdown | Select | • Loại: Tất cả / UBND tỉnh-thành / Doanh nghiệp / Trung ương; Địa bàn: theo danh mục Địa bàn; Site: theo danh mục Site; Tầng tiếp nhận: Tỉnh X / Helpdesk công ty / Hỗ trợ trung tâm. Kết hợp được. |
...
| 4 | Hình thức hỗ trợ | Radio group | Select | • **Chỉ hiện và bắt buộc khi Địa bàn = Trung ương**: Helpdesk công ty / Hỗ trợ trung tâm; không có giá trị mặc định (xem Trạng thái phụ Trung ương). Địa bàn tỉnh/TP → ẩn. |
| 5 | Tầng tiếp nhận | Label | ReadOnly | • Chỉ đọc, tự tính ngay khi đổi [3]/[4]: địa bàn tỉnh X → "Tỉnh X"; Trung ương + Helpdesk công ty → "Helpdesk công ty"; Trung ương + Hỗ trợ trung tâm → "Hỗ trợ trung tâm". Ticket mới của khách hàng vào đúng tầng này (`SRS` Chức năng 1 BR-01). |
...
│    │ Hình thức hỗ trợ [4]                                       │    │
│    │   ( ) Helpdesk công ty   (*) Hỗ trợ trung tâm              │    │
│    │ Tầng tiếp nhận [5]: Hỗ trợ trung tâm (tự tính, chỉ đọc)    │    │
│    ├────────────────────────────────────────────────────────────┤    │
│    │ Site sử dụng [6]               Mã đơn vị trên site [7]     │    │
...
│ Đỗ H          h.do@vnpt.vn     Hỗ trợ DV    (không tầng)   Hoạt động │
...
| 4 | Tầng / Địa bàn | Label | ReadOnly | • Nhân viên hỗ trợ: Agent tỉnh → "Tỉnh X" (Địa bàn được gán), Agent helpdesk → "Helpdesk công ty", Hỗ trợ trung tâm → "Hỗ trợ trung tâm", Hỗ trợ dịch vụ → không thuộc tầng nào. Khách hàng: đơn vị + các site khách hàng dùng (không đổi được site của người được mời). |
| 5 | Phạm vi phụ trách | Label (danh sách) | ReadOnly | • Chỉ hiện với Agent tỉnh, Agent helpdesk, Hỗ trợ trung tâm, Hỗ trợ dịch vụ: liệt kê các dòng Dịch vụ × Đối tượng hiện có. Với Agent tỉnh là giới hạn quyền xem; với các vai trò khác là bộ lọc mặc định. Sửa qua `qt-phan-quyen`. |
...
| 4 | Vai trò | Dropdown | Select | • **Bắt buộc**: Agent tỉnh / Agent helpdesk / Hỗ trợ trung tâm / Hỗ trợ dịch vụ / Biên tập nội dung / Quản trị viên / Chủ quản dịch vụ (7 vai trò nội bộ; vai trò Khách hàng không tạo ở đây). Chi tiết quyền xem `qt-phan-quyen`, `qt-ma-tran-phan-quyen`. |
...
│ ( ) Hỗ trợ trung tâm    xử lý ticket mọi tầng                        │
│ ( ) Hỗ trợ dịch vụ      xem mọi ticket + ghi chú nội bộ              │
...
├──────────────────────────────────────────────────────────────────────┤
│ Chức năng [3]             KH   AgT  AgH  HTT  HDV  BT   QT   CQ      │
│ ------------------------------------------------------------------   │
│ Tra cứu KB, hỏi AI        x    x    x    x    ?    x    x    -       │
│ Hỏi đáp AI nội bộ         -    x    x    x    x    -    x    x       │
│ Xem nghiệp vụ mọi KH(AI)  -    -    -    x    x    -    x    x       │
│ Tạo & theo dõi ticket     x    -    -    -    -    -    -    -       │
│ Xem ticket (theo phạm vi) -    x    x    x    x    -    x    -       │
│ Phản hồi CK, đổi TT, gán  -    x    x    x    -    -    x    -       │
│ Ghi chú nội bộ            -    x    x    x    x    -    x    -       │
...
│ KH=Khách AgT=A.tỉnh AgH=A.helpdesk HTT=HT trung tâm HDV=HT dịch vụ   │
...
| 3 | Bảng quyền | Table | ReadOnly | • Hàng = **14 nhóm chức năng**, cột = **8 vai trò** (KH, Agent tỉnh, Agent helpdesk, Hỗ trợ trung tâm, Hỗ trợ dịch vụ, Biên tập, Quản trị viên, Chủ quản dịch vụ). `x` = được phép, `-` = không, `cb` = chỉ xem báo cáo cơ bản trong phạm vi (Agent tỉnh), **`?` = chưa có nguồn, chờ khách hàng xác nhận** (Hỗ trợ dịch vụ với "Tra cứu KB, hỏi AI" và "Soạn bài KB"; Agent helpdesk và Hỗ trợ dịch vụ với "Xem báo cáo").<br>• Dòng ticket tách thành 3: **Xem ticket (theo phạm vi)**, **Phản hồi công khai, đổi trạng thái, phân công** (Hỗ trợ dịch vụ không có), **Ghi chú nội bộ** (Hỗ trợ dịch vụ có). "Tạo phiếu OneBSS" áp dụng cho ticket tầng Tỉnh/Helpdesk. "Tạo TK đầu mối KH": Agent tỉnh, Hỗ trợ trung tâm, Quản trị viên (Agent helpdesk và Hỗ trợ dịch vụ không tạo).<br>• **Chỉ xem**: đổi vai trò của 1 tài khoản làm ở `qt-phan-quyen`. Chỉ Quản trị viên mở được. Bảng vẫn chỉ mang tính tham khảo (OQ-28); các ô của vai trò mới suy từ SRS v1.1, Agent helpdesk theo Agent tỉnh khi chưa có nguồn riêng [GIẢ ĐỊNH]. |

- **Đề xuất bổ sung, đã chốt (OQ-28).** Vào từ `qt-phan-quyen` và `qt-danh-sach-tai-khoan`; ký hiệu: KH=Khách hàng, AgT=Agent tỉnh, AgH=Agent helpdesk, HTT=Hỗ trợ trung tâm, HDV=Hỗ trợ dịch vụ, BT=Biên tập, QT=Quản trị viên, CQ=Chủ quản dịch vụ.
...
| OQ-28 | Bảng quyền vai trò × chức năng chính thức (bổ sung OQ-23b) | Dùng `qt-ma-tran-phan-quyen` làm tham khảo; Agent tỉnh chỉ xem báo cáo cơ bản trong phạm vi phụ trách của mình (cập nhật 24/09/2026: bảng 8 vai trò). | Đã chốt (khách hàng xác nhận, 21/09/2026) |
