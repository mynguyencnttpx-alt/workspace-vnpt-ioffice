...
| 8 | Ô nhập phản hồi | Textbox (multi-line) | Text | • Khách hàng bổ sung thông tin/đính kèm cho đội hỗ trợ; hiển thị khi ticket chưa đóng (đặc biệt lúc "Chờ khách hàng"). Ticket đã đóng → ẩn, chuyển sang `ticket-da-dong` (mở lại).<br>• Khách hàng nhắn thêm khi đang "Chờ khách hàng xác nhận" thì trạng thái đổi thế nào: đã đề xuất, chờ xác nhận (OQ-17).<br>• Tệp chọn qua [11] hiện thành dòng "Đính kèm:" phía trên ô nhập, mỗi tệp có (x) để gỡ (xem Trạng thái phụ — soạn phản hồi kèm tệp) |
